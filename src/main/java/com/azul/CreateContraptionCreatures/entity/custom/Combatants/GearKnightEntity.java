...
public class GearKnightEntity extends AbstractCogBotEntity implements GeoEntity
{
	private AnimatableInstanceCache cache = AzureLibUtil.createInstanceCache(this);

	public GearKnightEntity(net.minecraft.entity.EntityType<? extends AbstractCogBotEntity> entityType, World world){
