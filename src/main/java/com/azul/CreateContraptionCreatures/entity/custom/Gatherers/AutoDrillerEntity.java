...
public class AutoDrillerEntity extends AbstractCogBotEntity
{
    ...
    public static boolean canSpawnCog(EntityType<? extends AutoDrillerEntity> type, ServerWorldAccess world, SpawnReason spawnReason, BlockPos pos, Random random) {
        return world.getDifficulty() != Difficulty.PEACEFUL && AutoDrillerEntity.isSpawnCorrect(world, pos, random) && AutoDrillerEntity.canMobSpawn(type, world, spawnReason, pos, random);
    }
}
